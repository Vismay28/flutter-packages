/// iOS implementation of the image_crop_compress platform interface.
///
/// This package provides native iOS image processing using:
/// - `CGImage` / `CGContext` / `CGAffineTransform` for crop, rotate, and flip
/// - `jpegData(compressionQuality:)` / `pngData()` for compression
/// - `CGImageSource` / `CGImageDestination` for format conversion and metadata
///
/// ## Registration
///
...
/// The iOS implementation of [ImageProcessorPlatform].
///
/// Registers itself as the platform implementation when the iOS
/// plugin is loaded by Flutter's plugin system.
class ImageCropCompressIos extends ImageProcessorPlatform {
  ...
  static void registerWith() {
    ImageProcessorPlatform.instance = ImageCropCompressIos();
  }
